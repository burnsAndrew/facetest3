...
exports.savingPhoto = functions.https.onCall(async (data, context) => {
  ...
  var image_original_url = await uploadPicture(
  ...
  faceapi.draw.drawDetections(image_process, fullFaceDescriptions, {
    lineWidth: 4,
    color: "blue"
  });
  faceapi.draw.drawFaceLandmarks(image_process, fullFaceDescriptions, {
    lineWidth: 4,
    color: "red"
  });
  ...
  var image_landmark_url = await uploadPicture(
